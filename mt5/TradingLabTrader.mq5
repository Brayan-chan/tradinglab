...
void Evaluate(){
  ...
  if(!buy&&!sell){
    // No hubo señal, pero registramos cuántas de las 3 condiciones (régimen H1, alineación M15, cruce M5)
    // sí se cumplieron para el lado dominante — así distinguimos "casi señal" de "nada alineado".
    ...
    SendDecision("no_setup","","Tendencia y retroceso M5 no están alineados",closedBar,EMPTY_VALUE,EMPTY_VALUE,EMPTY_VALUE,spreadPoints,h1Fast,h1Slow,m15Ema,m15Atr,m5Ema1,EMPTY_VALUE,MathMax(buyScore,sellScore));
    return;
  }
